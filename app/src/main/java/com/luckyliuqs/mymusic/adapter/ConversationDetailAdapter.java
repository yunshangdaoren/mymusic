...
public class ConversationDetailAdapter extends BaseRecyclerViewAdapter<Message, ConversationDetailAdapter.BaseViewHolder> {
     ...
     * 默认两条消息最大间隔时间为3分钟
     */
    private static final long DEFAULT_TIME_SPLIT = 3 * 60 * 1000;
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case TYPE_IMAGE_LEFT:
                return new ImageViewHolder(getInflater().inflate(R.layout.item_chat_image_left, viewGroup, false));
            case TYPE_IMAGE_RIGHT:
                return new ImageViewHolder(getInflater().inflate(R.layout.item_chat_image_right, viewGroup, false));
            case TYPE_TEXT_LEFT:
                return new TextViewHolder(getInflater().inflate(R.layout.item_chat_text_left, viewGroup, false));
            default:
                return new TextViewHolder(getInflater().inflate(R.layout.item_chat_text_right, viewGroup, false));
        }
    }
    ...
    abstract class BaseViewHolder extends BaseRecyclerViewAdapter.ViewHolder {
        ...
        public BaseViewHolder(View itemView) {
            super(itemView);
            tv_time = (TextView) findViewById(R.id.tv_time_chat_time);
        }
