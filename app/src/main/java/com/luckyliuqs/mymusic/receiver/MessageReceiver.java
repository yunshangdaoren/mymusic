package com.luckyliuqs.mymusic.receiver;
...
public class MessageReceiver extends PushMessageReceiver {
    ...
    @Override
    public boolean onNotificationMessageArrived(final Context context, PushType pushType, final PushNotificationMessage message) {
